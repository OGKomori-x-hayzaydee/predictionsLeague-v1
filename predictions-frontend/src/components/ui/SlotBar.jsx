    ...
    >
      ...
      {reelNav && (
        <div className="flex shrink-0 items-center gap-[11px]">
          ...
          <span className="min-w-[52px] text-center font-mono text-[11px] tracking-[0.14em] text-brand-teal">
            {reelNav.counter}
          </span>
          <button
          ...
          {reelNav.status && (
            <span
              className="whitespace-nowrap rounded-xs border px-[9px] py-[3px] font-mono text-[10px] tracking-[0.1em]"
      ...
      <div className="ml-auto flex shrink-0 items-center gap-3">
        {right && <span className="whitespace-nowrap font-mono text-[11px] text-text-muted-2">{right}</span>}
        {deadline && (
          <span className="flex shrink-0 items-center gap-[7px] rounded-full border border-border-control bg-surface-card-4/70 px-[11px] py-[5px]">
            ...
            <span className="whitespace-nowrap font-mono text-[10.5px] text-brand-amber">{deadline} to deadline</span>
          </span>
        )}
      </div>
    </div>
