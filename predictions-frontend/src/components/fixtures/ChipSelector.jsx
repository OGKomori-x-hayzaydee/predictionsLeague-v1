 ...
 * 5 cards horizontally on desktop with token badge, name, description, and "left" status.
 */
export default function ChipSelector({ chips = [], selected, onToggle }) {
  return (
    <div className="flex w-full flex-col gap-2">
      <span className="font-mono text-[10px] uppercase tracking-[0.16em] text-[#5b667d]">
        CHIPS · ONE PER MATCH
      </span>
        ...
        {CHIP_LIST.map((c) => {
          ...
          return (
            <button
              ...
              className={`flex cursor-pointer items-start gap-2.5 rounded-[11px] border p-2.5 text-left font-outfit transition-all ${
                isSelected
                  ? 'border-brand-amber bg-[#0d1c2ecc] shadow-[0_0_0_2px_#fcd34d33]'
                  : isUsed
            ...
            >
              ...
              <div className="flex flex-col items-center gap-1 shrink-0">
                <div
                  ...
                  style={{
                    ...
                    boxShadow: isSelected ? `0 0 12px #fcd34d40` : 'none',
                  }}
                >
                  <div
                    className="flex h-6 w-6 items-center justify-center rounded-full bg-[#08111f] font-mono text-[10px] font-bold"
                    style={{
              ...
              <div className="flex min-w-0 flex-1 flex-col gap-0.5">
                ...
                <span className="text-[10.5px] leading-relaxed text-[#8fa0b8]" style={{ textWrap: 'pretty' }}>
                  {c.desc}
                </span>
              </div>
            </button>
