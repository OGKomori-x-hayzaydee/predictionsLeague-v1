 ...
 * Amber chevrons + big DM Serif digit.
 */
export default function ScoreStepper({ team, value, onChange, size = 'md' }) {
  ...
  return (
    <div className="flex flex-col items-center gap-0.5">
      <button
        ...
        className="cursor-pointer p-0.5 leading-none text-[#fcd34d] transition-colors hover:text-[#fde68a]"
      >
      ...
      <input
        ...
        className="w-20 md:w-24 rounded-[10px] border-0 bg-transparent text-center font-dmSerif text-5xl md:text-[64px] leading-[0.86] text-white caret-[#fcd34d] outline-none focus:bg-[#0d1c2e99]"
      />
