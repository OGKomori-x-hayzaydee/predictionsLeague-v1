...
const FixtureCard = ({ 
  ...
  return (    <motion.div
    ...
    >      <div className={`flex justify-between items-center text-xs ${
        ...
        />        <div className="mx-2 flex-grow">          <div className="flex justify-between items-center">
            <span className={`${theme === 'dark' ? 'text-white' : 'text-slate-800'} font-medium`}>{fixture.homeTeam}</span>
            <span className={`${theme === 'dark' ? 'text-slate-400' : 'text-slate-500'} font-outfit`}>vs</span>
            <span className={`${theme === 'dark' ? 'text-white' : 'text-slate-800'} font-medium`}>{fixture.awayTeam}</span>
          </div>
        ...
        <div className={`text-xs ${theme === 'dark' ? 'text-white/60' : 'text-slate-500'}`}>
          {fixture.venue}
        </div>
        <div
