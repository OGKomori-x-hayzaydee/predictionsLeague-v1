        ...
        <form onSubmit={handleSubmit}>
          <AnimatePresence mode="wait">
            ...
            {currentStep === 1 && (
              ...
              >
                <div className="mb-5">
                  <h3 className="text-teal-200 text-lg font-dmSerif mb-3">
            ...
            {currentStep === 2 && (
              ...
              >
                ...
                <div className="mb-5">
                  <div>
                    <div className="flex items-center justify-between">
                      <h3 className="text-teal-200 text-lg font-dmSerif flex items-center">
                        Goalscorers
                      </h3>
                    </div>
            ...
            {currentStep === 3 && (
              <motion.div
                ...
                className="pb-4"
              >
                <h3 className="text-teal-200 text-lg font-dmSerif mb-4">
                  Review
                </h3>
