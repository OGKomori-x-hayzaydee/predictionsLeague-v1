...
export default function StatusBar({ user }) {
  ...
  const userData = user || {
    ...
    points: 1250,
    rank: 567,
    rankChange: 24, // positive means improved rank (moved up)
    nextMatchTime: "2025-05-12T15:00:00", // ISO format for the next upcoming match
    predictions: 28, // predictions made this season
    pendingPredictions: 0, // pending predictions for the upcoming gameweek
  };
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <div className="flex items-center text-xs text-white/60">
                ...
                <span className={`flex items-center ml-2 ${userData.rankChange > 0 ? 'text-green-400' : 'text-red-400'}`}>
