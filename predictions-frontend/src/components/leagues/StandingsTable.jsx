  ...
  return (
    <div className="divide-y divide-border-base">
      {standings.map((m) => (
        ...
        >
          <span className="w-6 font-mono text-xs text-text-muted-2">{m.position}</span>
          <Avatar name={m.displayName || m.username} size={26} />
          ...
          <span className="font-mono text-xs text-text-muted-2">{m.predictions ?? 0} calls</span>
