...
export function useDashSpineVariant() {
...
/**
 * Temporary compare control for the dashboard fixture-preview spines.
 * Not product UI — labelled as a preview picker so it can be shelved
 * once one variant is chosen.
 */
export default function SpinePreviewSwitcher({ value, onChange }) {
  return (
    <div className="mb-2.5 flex flex-wrap items-center justify-between gap-2">
      ...
      <div
        role="group"
        aria-label="Spine preview variants"
